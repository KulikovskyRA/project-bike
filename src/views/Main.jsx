              ...
              <div className="card bg-white p-4" id={way.id}>
                ...
                {user?.admin === true ? (
                  <div>
                    ...
                    <button
                      type="button"
                      className="adminDel flex w-full justify-center rounded-md bg-gray-900 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                    >
                      Удалить
                    </button>
                  </div>
