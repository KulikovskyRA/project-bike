        ...
        <div className="py-24 sm:py-32">
          <div className="p-4">
            <div className="max-w-2xl">
              <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">{oneWay.title}</h2>
            ...
            <ul role="list" className="mt-6">
              <li>
                <div className="items-center gap-x-6">
                  ...
                  <div className="mt-8">
                    <button id="buttonLeaveFeedback" type="button" className="flex w-full justify-center rounded-md btn-otz px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                      Оставить отзыв
                      <br />
          ...
          <label htmlFor="rating5">5</label>
                  ...
                  <div className="mt-8">
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Отзывы:</h2>
                    <ul role="list" className="divide-y mt-6 divide-gray-100 review_all">
                      {reviews.map((review) => (
                        <li key={`review${review.id}`} className="flex p-4 bg-white justify-between gap-x-6 py-5">
                          <div className="flex gap-x-4">
                            <div className="min-w-0 flex-auto">
                              <p className="text-sm font-semibold leading-6 text-gray-900">{review['User.username']}</p>
                              <p className="mt-1 truncate text-xs leading-5 text-gray-500">{review.text_body}</p>
                            </div>
                          </div>
                          <div className="hidden sm:flex sm:flex-col sm:items-end">
                            <p className="text-sm leading-6 text-gray-900">Добавлено:</p>
                            <p className="mt-1 text-xs leading-5 text-gray-500">{review.createdAt.toLocaleString()}</p>
                          </div>
                        </li>
                      ))}
